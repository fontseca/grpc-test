...
PROTOBUF_NAMESPACE_OPEN
template<> ::gRPCTest::Protos::Models::Product* Arena::CreateMaybeMessage<::gRPCTest::Protos::Models::Product>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace gRPCTest {
namespace Protos {
namespace Models {
...
class Product final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:gRPCTest.Protos.Models.Product) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "gRPCTest.Protos.Models.Product";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:gRPCTest.Protos.Models.Product)
 private:
  class _Internal;
...
inline const std::string& Product::name() const {
  // @@protoc_insertion_point(field_get:gRPCTest.Protos.Models.Product.name)
...
void Product::set_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:gRPCTest.Protos.Models.Product.name)
}
inline std::string* Product::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:gRPCTest.Protos.Models.Product.name)
  return _s;
}
...
inline std::string* Product::release_name() {
  // @@protoc_insertion_point(field_release:gRPCTest.Protos.Models.Product.name)
...
inline void Product::set_allocated_name(std::string* name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:gRPCTest.Protos.Models.Product.name)
}
...
inline double Product::price() const {
  // @@protoc_insertion_point(field_get:gRPCTest.Protos.Models.Product.price)
...
inline void Product::set_price(double value) {
  ...
  // @@protoc_insertion_point(field_set:gRPCTest.Protos.Models.Product.price)
}
