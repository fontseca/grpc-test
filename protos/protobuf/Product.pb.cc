...
static ::_pb::Metadata file_level_metadata_Product_2eproto[1];
...
const uint32_t TableStruct_Product_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::gRCPTest::Protos::Models::Product, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::gRCPTest::Protos::Models::Product, _impl_.id_),
  PROTOBUF_FIELD_OFFSET(::gRCPTest::Protos::Models::Product, _impl_.name_),
  PROTOBUF_FIELD_OFFSET(::gRCPTest::Protos::Models::Product, _impl_.price_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::gRCPTest::Protos::Models::Product)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::gRCPTest::Protos::Models::_Product_default_instance_._instance,
};

const char descriptor_table_protodef_Product_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\rProduct.proto\022\026gRCPTest.Protos.Models\""
...
const ::_pbi::DescriptorTable descriptor_table_Product_2eproto = {
    false, false, 99, descriptor_table_protodef_Product_2eproto,
    "Product.proto",
    &descriptor_table_Product_2eproto_once, nullptr, 0, 1,
...
Product::Product(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:gRCPTest.Protos.Models.Product)
}
Product::Product(const Product& from)
  ...
  // @@protoc_insertion_point(copy_constructor:gRCPTest.Protos.Models.Product)
}
...
Product::~Product() {
  // @@protoc_insertion_point(destructor:gRCPTest.Protos.Models.Product)
...
void Product::Clear() {
// @@protoc_insertion_point(message_clear_start:gRCPTest.Protos.Models.Product)
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "gRCPTest.Protos.Models.Product.name"));
        } else
          goto handle_unusual;
        continue;
      // double price = 3;
...
uint8_t* Product::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:gRCPTest.Protos.Models.Product)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_name().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "gRCPTest.Protos.Models.Product.name");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:gRCPTest.Protos.Models.Product)
  return target;
}

size_t Product::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:gRCPTest.Protos.Models.Product)
  size_t total_size = 0;
...
void Product::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:gRCPTest.Protos.Models.Product)
...
// @@protoc_insertion_point(class_specific_copy_from_start:gRCPTest.Protos.Models.Product)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::gRCPTest::Protos::Models::Product*
Arena::CreateMaybeMessage< ::gRCPTest::Protos::Models::Product >(Arena* arena) {
  return Arena::CreateMessageInternal< ::gRCPTest::Protos::Models::Product >(arena);
}
